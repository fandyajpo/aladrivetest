...
const PickUp = (props) => {
  ...
  return (
    <>
      <Modal
        isOpen={props.pickUp}
        onClose={props.handleClosePickup}
          ...
          <div className="space-y-14">
            ...
            <div className="flex items-center justify-center w-full gap-x-4">
              <div className="w-full">
                <button
                  onClick={props.handleClosePickup}
              ...
              <div className="w-full">
                <button
                  onClick={(e) => {
                    ...
                    Progress.set.setProgress("on-the-way");
                    props.handleClosePickup(e);
                  }}
                  className="bg-custom-blue rounded-full w-full"
                >
                  <p className="text-white font-bold text-s py-3">Antar</p>
                </button>
              </div>
            </div>
          </div>
