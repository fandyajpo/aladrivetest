  ...
  return (
    <>
      <RemoveOutlet
        title={"Hapus Outlet"}
        description={
          "Setelah ini kamu tidak akan menerima orderan dari outlet tersebut "
        }
        remove={remove}
      ...
      `}</style>
      <div className="w-full h-full bg-white relative overflow-hidden text-custom-black p-4 flex flex-col pb-36">
        ...
        {/* <div className="py-6">
          <button
            className="bg-red-400 w-full rounded-full"
            onClick={handleOpenRemove}
          >
            <p className="p-3 text-white">Hapus Outlet</p>
          </button>
        </div> */}
      </div>
      <BackNav
