...
const HomeOrder = () => {
  return (
    <div className="w-full pb-44 px-4">
      ...
      <div className="divide-y w-full space-y-4 ">
        ...
        <div className="py-2 w-full">
          <div>
            <p className="text-md text-custom-black font-bold">Detail Order</p>
          </div>
          ...
          <div className="py-2 flex flex-row items-center justify-between w-full">
            <div>
              <p className="text-s text-custom-black font-bold">Grand Total</p>
            </div>
            <div>
