...
/* harmony import */ var components_footer_customKeyboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3676);
...
const PinPenarikan = ()=>{
    const previous = (0,react__WEBPACK_IMPORTED_MODULE_5__.useRef)();
    const { 0: otpPin , 1: setOtpPin  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    const { 0: proses , 1: setProses  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    ...
    const PROSES = (0,react_spring__WEBPACK_IMPORTED_MODULE_4__.useSpring)({
        to: {
            y: proses ? 0 : 1000
        }
    });
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                className: "space-y-12 py-12 pb-96",
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                ...
                                children: "Pin Verifikasi"
                            }),
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                className: "text-md",
                                children: "Masukan pin untuk penarikan"
                            })
                        ]
                    }),
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: `${otpData[0].length > 0 ? "bg-custom-blue h-6 w-6" : "bg-blue-400 h-4 w-4"} rounded-full duration-500`
                            }),
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: `${otpData[0].length > 1 ? "bg-custom-blue h-6 w-6" : "bg-blue-400 h-4 w-4"} rounded-full duration-500`
                            }),
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: `${otpData[0].length > 2 ? "bg-custom-blue h-6 w-6" : "bg-blue-400 h-4 w-4"} rounded-full duration-500`
                            }),
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: `${otpData[0].length > 3 ? "bg-custom-blue h-6 w-6" : "bg-blue-400 h-4 w-4"} rounded-full duration-500`
                            }),
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: `${otpData[0].length > 4 ? "bg-custom-blue h-6 w-6" : "bg-blue-400 h-4 w-4"} rounded-full duration-500`
                            }),
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: `${otpData[0].length > 5 ? "bg-custom-blue h-6 w-6" : "bg-blue-400 h-4 w-4"} rounded-full duration-500`
                            })
                        ]
                    }),
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_footer_customKeyboard__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
                position: "bottom-0",
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_footer_backNav__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                ...
                ,
                bottomButton: "Ok",
                bottomAction: ()=>router.push("loading-ubah-rekening", "loading-ubah-rekening")
                ,
                block: otpData[0].length !== 6,
                classButton: otpData[0].length > 5 ? "bg-custom-blue text-white" : "bg-custom-btnGray text-white",
                position: "bottom-60"
            })
        ]
    }));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PinPenarikan);
...
var __webpack_exports__ = __webpack_require__.X(0, [2357,3676], () => (__webpack_exec__(7029)));
